    ...
    <div className="h-screen  bg-[#d6a78f] ">
      ...
      <div ref={containerRef} className="max-w-4xl mx-auto p-4 space-y-4">
        {additionalService.length === 0 ? (
          ...
          ">
              {/* Title */}
              <h3 className="text-lg font-semibold text-[#7f3d45] mb-2">
                {item.name}
              </h3>
              ...
              <div className="text-[#7f3d45] text-sm">{item.description}</div>
              <div className="border-t border-[#7f3d45] my-2"></div>
              ...
              {item.price && (
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[#7f3d45] font-bold text-base">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-[#7f3d45] text-white py-2 rounded-xl font-medium hover:bg-[#7f3d45] transition">
                  انتخاب سرویس
                </button>
      ...
      {/* <div className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg p-4">
        <div className="max-w-4xl mx-auto">
          <button
            onClick={() => navigate('/employees')}
            className="w-full bg-[#7f3d45] text-white py-3 rounded-xl font-medium hover:bg-[#6e353f] transition">
            {t('skip')}
          </button>
        </div>
      </div> */}
