...
export default function CardNumberField() {
  const cardNumber = '6219 8619 8629 0962';
  ...
  return (
    <div className="relative flex items-center justify-between bg-gray-100 px-4 py-3 rounded-xl shadow-sm w-full max-w-sm">
      <span className="font-mono text-lg tracking-widest">{cardNumber}</span>
